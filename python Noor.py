...
| $$  \$$$ \$$    $$ \$$   $$   $$ \$$    $$| $$    $$
 \$$   \$$  \$$$$$$$  \$$$$$\$$$$   \$$$$$$$ \$$$$$$$ 
                          ...
                          \033[1;33m.ITS N4W9BZ4D4 H3R3                            
                     \033[1;33m.MOBILE NO 9927564009
\033[1;33m.FACEBOOK ID https://www.facebook.com/Nawab082                                  
                                                                                                                                              
------------------------------------------------------------------------------------------
Tool Type::- Conversation Tool ITS N4W9BZ4D4 KH4N H3R3
  GOLD3N URF JH4T V4MPIR3 W4LO K4 JIJU BOLT1 PUBL1C
------------------------------------------------------------------------------------------
                                                                                          """
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/Nawabzada08/Noorjha/blob/main/Aproval.txt').text
    if id in httpCaht:
      ...
      print('\33[1;37m----------------------------------------------')
      print ('Tool Owner: Nawabzada-')
      print("Your Token : "+id)
      input('IF U WANT TO BUY THEN PRESS ENTER ')
      tks = ('Hello%20Nawabzada%20!%20Please%20Approve%20My%20Token%20My%20Token%20Is%20:%20'+id)
